(function () {
    ...
    const quotes = [
        ...
        "</code>inherited context::''wide ceramic pot''</code>",
        ...
        "Hello! You have reached Nerve's Ending.",
        "Technically, there is at least one person who added quotes. Thanks! <small>Does that count as an internship?</small>",
        "John Greytide says, ';cling maint'",
        "Refer ALL the links.",
        "Why do they call it simulacrum when you sim in the crum of sim out the crum?",
        "Listen to <a href=\"https://halleylabs.com/\" target=\"_blank\"><i>Halley Labs</i></a>' music!! </small>Some stranger told me to add this.</small>",
        ...
        "<small>Mrrp. :3</small>",
        "<small>You just got</small> COCONUT MALLED.",
